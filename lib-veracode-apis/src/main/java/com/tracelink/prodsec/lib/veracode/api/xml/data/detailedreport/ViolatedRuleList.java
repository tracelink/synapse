...
@XmlType(name = "ViolatedRuleList", namespace = "https://www.veracode.com/schema/reports/export/1.0", propOrder = {
		"policyRule"
})
public class ViolatedRuleList {
	 ...
	 * {@link PolicyRule }
	 *
	 * @return value of the policyRule property, or an empty list if the policyRule property is null
	 */
