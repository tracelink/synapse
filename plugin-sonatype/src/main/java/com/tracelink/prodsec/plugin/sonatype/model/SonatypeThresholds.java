 ...
 * SonatypeMetrics} associated with a particular {@link ProjectModel}. They are
 * configurable so that risk tolerance can be adjusted over time.
 *
 * @author mcool
 */
@Entity
@Table(schema = SonatypePlugin.SCHEMA, name = "sonatype_thresholds")
public class SonatypeThresholds {
    @Id
