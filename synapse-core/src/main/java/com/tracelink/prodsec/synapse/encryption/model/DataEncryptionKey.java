package com.tracelink.prodsec.synapse.encryption.model;

import com.tracelink.prodsec.synapse.auth.SynapseAdminAuthDictionary;
import com.tracelink.prodsec.synapse.encryption.converter.DataEncryptionKeyConverter;
import com.tracelink.prodsec.synapse.util.converter.HexAttributeConverter;
...
/**
 * Model for the Synapse data encryption key. Includes the name of the encrypted attribute
 ...
 */
@Entity
@Table(schema = SynapseAdminAuthDictionary.DEFAULT_SCHEMA, name = "data_encryption_keys")
public class DataEncryptionKey {
	...
	/**
	 * Tells whether this data encryption key is disabled. A key is disabled if Synapse is
