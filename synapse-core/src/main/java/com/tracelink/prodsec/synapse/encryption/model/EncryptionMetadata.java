...
/**
 * Model for Synapse encryption metadata. Includes the date and time of the last key encryption key
 ...
 */
@Entity
@Table(schema = SynapseAdminAuthDictionary.DEFAULT_SCHEMA, name = "encryption_metadata")
