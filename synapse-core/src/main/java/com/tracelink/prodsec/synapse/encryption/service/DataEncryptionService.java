...
public class DataEncryptionService {
	 ...
	 * this method will attempt to encrypt the attribute using a previous key. If Synapse is
	 ...
	 *                       DataEncryptionKey}
	 * @return the encrypted attribute, or null if Synapse is configured with {@link
	...
	public String encryptString(String attribute, Class<?> converterClass) {
		// If attribute is null or Synapse is not configured to handle encryption, return attribute
	...
	public String decryptString(String dbData, Class<?> converterClass) {
		// If dbData is null or Synapse is not configured to handle encryption, return dbData
